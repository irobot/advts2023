...
type Winning = [Rock, Scissors] | [Scissors, Paper] | [Paper, Rock];

type WhoWins<Them extends RockPaperScissors, Me extends RockPaperScissors> = [
	Me,
	Them,
] extends Winning
	? "win"
	: [Them, Me] extends Winning ? "lose" : "draw";
